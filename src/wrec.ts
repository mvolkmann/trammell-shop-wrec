...
//TODO: The DOM parser sees tags inside JS expressions as elements.
// This makes it so the expressions cannot contain tags.
/*
function commentExpressions(element: Element) {
  if (element.childElementCount > 0) {
    for (const child of Array.from(element.children)) {
      commentExpressions(child);
    }
  } else {
